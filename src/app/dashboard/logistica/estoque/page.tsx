...
// // HELPERS
// // ─────────────────────────────────────────────
// function calculateStockBalance(movements: any[]): Record<string, StockBalance> {
...
//       balances[mov.productId].totalValue -= mov.totalCost;
//     }
//     balances[mov.productId].lastUpdate = mov.createdAt;
//   });
...
//   const stockBalance = useMemo(() => calculateStockBalance(stockMovements), [stockMovements]);

//   // Filtrar movimentações
//   const filteredMovements = useMemo(() => {
//     return stockMovements.filter((mov: { productId: string; type: string; createdAt: string; }) => {
//       const prod = products.find((p: { id: string; }) => p.id === mov.productId);
...
//     });
//   }, [stockMovements, searchTerm, filterType, historicoDe, historicoAte, products]);
...
//     // Chamar API para adicionar movimento
...
//       })
//       .catch(() => toast({ variant: "destructive", title: "Erro", description: "Falha ao registrar entrada." }));
//   };

//   const handleDeleteMovement = (movementId: string) => {
//     toast({ title: "Operação não permitida", description: "Movimentos não podem ser deletados para manter auditoria." });
//   };
...
//       return {
//         DATA: format(new Date(mov.createdAt), 'dd/MM/yyyy HH:mm'),
...
//                 </TableHeader>
//                 <TableBody>
//                   {stockMovements.filter((m: { type: string; }) => m.type === 'ENTRADA').length === 0 ? (
//                     <TableRow>
...
//                   ) : (
//                     stockMovements
//                       .filter((m: { type: string; }) => m.type === 'ENTRADA')
//                       .sort((a: { createdAt: string; }, b: { createdAt: string; }) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime())
//                       .slice(0, 20)
//                       .map((mov: { productId: string; id: Key | null | undefined; quantity: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; unitCost: { toLocaleString: (arg0: string, arg1: { minimumFractionDigits: number; }) => string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; }; totalCost: { toLocaleString: (arg0: string, arg1: { minimumFractionDigits: number; }) => string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; }; reason: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; createdAt: string | number | Date; }) => {
//                         const prod = products.find(p => p.id === mov.productId);
//                         return (
...
//                 </TableHeader>
//                 <TableBody>
//                   {stockMovements.filter(m => m.type === 'SAIDA').length === 0 ? (
//                     <TableRow>
//                       <TableCell colSpan={6} className="text-center py-12 text-muted-foreground italic text-xs uppercase opacity-40">
...
export default function EstoquePage() {
  return (
    <div className="p-4">
      <h1 className="text-2xl font-black">Em Construção</h1>
      <p className="text-muted-foreground">A funcionalidade de estoque está sendo desenvolvida e estará disponível em breve.</p>
    </div>
  );
}
